...
package Util.Systems.Constants is
   ...
   O_CLOEXEC                     : constant Interfaces.C.int := 8#200000#;
   ...
   XCASE   : constant := 8#100000000#; --  Canonical upper/lower presentation
   ...
   ONOCR   : constant := 8#000100#; --  No CR output at column 0
   ONLRET  : constant := 8#000200#; --  NL performs CR function
   ...
   RTLD_NOLOAD                   : constant Interfaces.C.int := 8#004000#;
